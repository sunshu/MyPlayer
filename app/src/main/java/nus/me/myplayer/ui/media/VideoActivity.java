package nus.me.myplayer.ui.media;
...
import nus.me.myplayer.ui.media.my.MyMainActivity;

public class VideoActivity extends AppCompatActivity {


    private static final String DEFAULT_TEST_URL = "rtmp://192.168.1.106/mylie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_my).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(VideoActivity.this, cls);
